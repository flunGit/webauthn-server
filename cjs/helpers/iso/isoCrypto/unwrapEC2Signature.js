...
const { AsnParser } = require('@peculiar/asn1-schema'), { ECDSASigValue } = require('@peculiar/asn1-ecc'),
    { COSECRV } = require('../../cose.js'), { concat } = require('../isoUint8Array.js');
...
module.exports = { unwrapEC2Signature };