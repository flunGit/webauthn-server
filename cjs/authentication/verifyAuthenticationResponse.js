...
const { isoBase64URL, isoUint8Array, decodeClientDataJSON, toHash, verifySignature, parseAuthenticatorData,
    parseBackupFlags, matchExpectedRPID } = require('../helpers/index.js'), { isBase64URL, toBuffer } = isoBase64URL;
