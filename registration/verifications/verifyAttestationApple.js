...
import { validateCertificatePath, convertCertBufferToPEM, toHash, convertCOSEtoPKCS, isoUint8Array } from '../../helpers/index.js';

const { concat, areEqual } = isoUint8Array;
/**
...
async function verifyAttestationApple(options) {
    ...
    if (!areEqual(credPubKeyPKCS, credCertSubjectPublicKey))
        throw new Error('凭证公钥不等于凭证证书中的公钥 (Apple)');
