 ...
 * - 查看定义:@see {@link parseAuthenticatorData}
 *
 * @param {BufferSource} authData - 认证器数据字节序列
 * @returns {{
 *   rpIdHash: Uint8Array,
 *   flagsBuf: Uint8Array,
 *   flags: { up: boolean, uv: boolean, be: boolean, bs: boolean, at: boolean, ed: boolean, flagsInt: number },
 *   counter: number,
